...
async function main() {
  ...
  await prisma.section.createMany({
    data: [
      {
        name: "Section Keunggulan",
        title: "Website ini tampil seperti brand yang siap menerima order.",
        content:
      ...
      },
      {
        name: "hero_badge",
        title: "Badge hero",
        content: "Qurban & aqiqah amanah, cepat, dan siap closing via WhatsApp",
        label: "Hero",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      },
      {
        name: "hero_title",
        title: "Judul hero",
        content: "Jasa qurban dan aqiqah yang tampil profesional, terasa amanah, dan siap langsung closing lewat WhatsApp.",
        label: "Hero",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      },
      {
        ...
        content: "Kami bantu keluarga, komunitas, dan panitia mendapatkan pilihan kambing, sapi, kerbau, serta paket aqiqah yang jelas harganya, rapi pelayanannya, dan nyaman dikonsultasikan tanpa ribet.",
        label: "Hero",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      ...
      {
        name: "hero_highlight_1_title",
        title: "Hero card 1 judul",
        content: "Sesuai Syariat",
        label: "Hero",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      ...
      {
        name: "hero_highlight_1_text",
        title: "Hero card 1 deskripsi",
        content: "Seleksi hewan, proses, dan penyaluran dirancang untuk menjaga kepercayaan pelanggan.",
        label: "Hero",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      ...
      {
        name: "hero_highlight_2_title",
        title: "Hero card 2 judul",
        content: "Harga Masuk Akal",
        label: "Hero",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      ...
      {
        name: "hero_highlight_2_text",
        title: "Hero card 2 deskripsi",
        content: "Pilihan paket dibuat realistis untuk keluarga, kolektif, hingga acara komunitas besar.",
        label: "Hero",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      ...
      {
        name: "hero_highlight_3_title",
        title: "Hero card 3 judul",
        content: "Pelayanan Amanah",
        label: "Hero",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      ...
      {
        name: "hero_highlight_3_text",
        title: "Hero card 3 deskripsi",
        content: "Komunikasi cepat, update jelas, dan semua arahan pembelian langsung diarahkan ke WhatsApp.",
        label: "Hero",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      ...
      {
        name: "keunggulan_eyebrow",
        title: "Eyebrow keunggulan",
        content: "Keunggulan",
        label: "Keunggulan",
        kind: "copy",
        isActive: true,
      ...
      {
        name: "keunggulan_title",
        title: "Judul section keunggulan",
        content: "Website ini tampil seperti brand yang siap menerima order.",
        label: "Keunggulan",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      ...
      {
        name: "keunggulan_description",
        title: "Deskripsi section keunggulan",
        content: "Setiap section dibuat untuk membangun rasa percaya, menjelaskan value, lalu mengarahkan pengunjung ke percakapan WhatsApp secepat mungkin.",
        label: "Keunggulan",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      ...
      {
        name: "category_title",
        title: "Judul section kategori",
        content: "Produk yang paling sering dicari pelanggan",
        label: "Kategori",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      },
      {
        ...
        title: "Deskripsi section kategori",
        content: "Dibuat untuk pengunjung yang ingin cepat paham pilihan paket, kisaran harga, dan langsung lanjut chat tanpa harus bingung cari informasi ke banyak tempat.",
        label: "Kategori",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
      ...
      {
        name: "product_heading_template",
        title: "Template judul section produk",
        content: "Rekomendasi {category} siap ditawarkan hari ini",
        label: "Produk",
        kind: "copy",
        isActive: true,
        sortOrder: 0,
